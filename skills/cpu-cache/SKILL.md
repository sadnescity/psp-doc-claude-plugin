---
name: cpu-cache
description: "YAPSPD's cache chapter, which reproduces Jeremy Fitzhardinge's HOWTO almost verbatim and drops its opening section along the way. Read the cache skill instead: it is the same text, complete and without the transcription slips. Kept only so the chapter is not missing."
---
